...
One open question is the scope of this package. For instance, it would be
natural to write a `pca` and a `tsne` method for the class. Do these methods
belong here or do we want to keep this package as light as possible with only
